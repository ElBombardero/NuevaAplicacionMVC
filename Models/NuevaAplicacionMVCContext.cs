...
{
    public class NuevaAplicacionMVCContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<NuevaAplicacionMVC.Models.NuevaAplicacionMVCContext>());

        public NuevaAplicacionMVCContext() : base("name=NuevaAplicacionMVCContext")
        {
        }
